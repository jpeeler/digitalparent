...
{  media_player_dlg = this;
   ...
   image14 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-cdrom"), Gtk::IconSize(4)));
   label12 = Gtk::manage(new class Gtk::Label(_("DVD-ROM")));
   hbox7 = Gtk::manage(new class Gtk::HBox(false, 2));
   alignment9 = Gtk::manage(new class Gtk::Alignment(0.5, 0.5, 0, 0));
   open_media_button = Gtk::manage(new class Gtk::Button());
   image18 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-properties"), Gtk::IconSize(4)));
   label16 = Gtk::manage(new class Gtk::Label(_("Rating")));
   hbox11 = Gtk::manage(new class Gtk::HBox(false, 2));
   alignment13 = Gtk::manage(new class Gtk::Alignment(0.5, 0.5, 0, 0));
   discRatingButton = Gtk::manage(new class Gtk::Button());
   ...
   image15 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-cut"), Gtk::IconSize(4)));
   label13 = Gtk::manage(new class Gtk::Label(_("Video")));
   hbox8 = Gtk::manage(new class Gtk::HBox(false, 2));
   alignment10 = Gtk::manage(new class Gtk::Alignment(0.5, 0.5, 0, 0));
   ...
   hbox7->pack_start(*image14, Gtk::PACK_SHRINK, 0);
   hbox7->pack_start(*label12, Gtk::PACK_SHRINK, 0);
   alignment9->add(*hbox7);
   ...
   open_media_button->add(*alignment9);
   image18->set_alignment(0.5,0.5);
   image18->set_padding(0,0);
   ...
   hbox11->pack_start(*image18, Gtk::PACK_SHRINK, 0);
   hbox11->pack_start(*label16, Gtk::PACK_SHRINK, 0);
   alignment13->add(*hbox11);
   discRatingButton->set_size_request(96,32);
   discRatingButton->set_flags(Gtk::CAN_FOCUS);
   discRatingButton->set_relief(Gtk::RELIEF_NORMAL);
   discRatingButton->add(*alignment13);
   ...
   hbox8->pack_start(*image15, Gtk::PACK_SHRINK, 0);
   hbox8->pack_start(*label13, Gtk::PACK_SHRINK, 0);
   alignment10->add(*hbox8);
   ...
   fixed1->put(*discRatingButton, 568, 0);
   ...
   discRatingButton->signal_clicked().connect(SigC::slot(*this, &media_player_dlg_glade::on_discRatingButton_clicked), false);
