// generated 2007/10/23 10:00:57 EDT by jmorey@jmorey-desktop.(none)
...
{  welcome_dlg = this;
   ...
   welcome_hint_label->set_size_request(216,40);
   welcome_hint_label->set_alignment(0.5,0.5);
   welcome_hint_label->set_padding(0,0);
   welcome_hint_label->set_justify(Gtk::JUSTIFY_CENTER);
   welcome_hint_label->set_line_wrap(true);
   welcome_hint_label->set_use_markup(false);
   welcome_hint_label->set_selectable(false);
   fixed6->put(*init_password_edit_box, 176, 0);
   fixed6->put(*repeat_password_edit_box, 176, 40);
   fixed6->put(*secret_q_edit_box, 176, 80);
   fixed6->put(*secret_a_edit_box, 176, 120);
   fixed6->put(*init_password_label, 32, 8);
   fixed6->put(*repeat_password_label, 32, 48);
   fixed6->put(*secret_question_label, 32, 88);
   fixed6->put(*secret_answer_label, 32, 128);
   fixed6->put(*welcome_next_button, 480, 128);
   fixed6->put(*welcome_hint_label, 360, 24);
