// generated 2007/10/18 15:51:05 EDT by jmorey@jmorey-laptop.(none)
...
{  media_player_dlg = this;
   ...
   pause_button = Gtk::manage(new class Gtk::Button(Gtk::StockID("gtk-media-pause")));
   play_button = Gtk::manage(new class Gtk::Button(Gtk::StockID("gtk-media-play")));
   ...
   pause_button->set_size_request(134,56);
   ...
   fixed1->put(*pause_button, 152, 8);
   fixed1->put(*play_button, 296, 8);
