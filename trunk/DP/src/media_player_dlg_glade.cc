// generated 2007/10/30 12:11:18 EDT by jmorey@jmorey-desktop.(none)
...
{  media_player_dlg = this;
   ...
   image10 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-cut"), Gtk::IconSize(4)));
   label2 = Gtk::manage(new class Gtk::Label(_("Audio")));
   hbox2 = Gtk::manage(new class Gtk::HBox(false, 2));
   alignment2 = Gtk::manage(new class Gtk::Alignment(0.5, 0.5, 0, 0));
   cut_audio = Gtk::manage(new class Gtk::ToggleButton());
   ...
   hbox2->pack_start(*image10, Gtk::PACK_SHRINK, 0);
   hbox2->pack_start(*label2, Gtk::PACK_SHRINK, 0);
   alignment2->add(*hbox2);
   cut_audio->set_size_request(96,32);
   cut_audio->set_flags(Gtk::CAN_FOCUS);
   cut_audio->set_relief(Gtk::RELIEF_NORMAL);
   cut_audio->set_active(false);
   cut_audio->add(*alignment2);
   ...
   cut_audio->signal_toggled().connect(SigC::slot(*this, &media_player_dlg_glade::on_cut_audio_toggled), false);
