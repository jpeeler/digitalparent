// generated 2007/11/23 11:07:56 EST by jmorey@jmorey-desktop.(none)
...
protected:
        ...
        ~login_dlg_glade();
private:
        virtual bool on_admin_psswrd_edit_box_key_press_event(GdkEventKey *ev) = 0;
        virtual bool on_secret_a_edit_box_key_press_event(GdkEventKey *ev) = 0;
        virtual bool on_icon1_password_edit_box_key_press_event(GdkEventKey *ev) = 0;
        virtual bool on_icon2_password_edit_box_key_press_event(GdkEventKey *ev) = 0;
        virtual bool on_icon3_password_edit_box_key_press_event(GdkEventKey *ev) = 0;
        virtual void on_previous_user_button_clicked() = 0;
        virtual void on_next_user_button_clicked() = 0;
        virtual void on_back_button_clicked() = 0;
        ...
        virtual bool on_login_dlg_delete_event(GdkEventAny *ev) = 0;
};
#endif
