// generated 2007/10/30 0:33:52 EDT by jmorey@jmorey-desktop.(none)
...
{  login_dlg = this;
   ...
   const std::string admin_image = "/Projects/DP/pixmaps/tux.png";   
   admin_icon = Gtk::manage(new class Gtk::Image(admin_image));  
   ...
   const std::string user_button1_image = "/Projects/DP/pixmaps/eye.png";   
   user_button1_icon = Gtk::manage(new class Gtk::Image(user_button1_image));    
   user_icon_select_button_1 = Gtk::manage(new class Gtk::Button());
   
   const std::string user_button2_image = "/Projects/DP/pixmaps/tired_smile.png";   
   user_button2_icon = Gtk::manage(new class Gtk::Image(user_button2_image));  
   user_icon_select_button_2 = Gtk::manage(new class Gtk::Button());
   
   const std::string user_button3_image = "/Projects/DP/pixmaps/truck.png";   
   user_button3_icon = Gtk::manage(new class Gtk::Image(user_button3_image));  
