...
{  login_dlg = this;
   ...
   login_text_box->set_size_request(152,72);
   ...
   login_text_box->set_justification(Gtk::JUSTIFY_FILL);
   login_text_box->get_buffer()->set_text(_("Enter Admin Password or Select a User From Below"));
   ...
   fixed5->put(*login_text_box, 208, 32);
